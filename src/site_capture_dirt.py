...
try:
    ...
    num=1
try:
    os.mkdir(f"{currdir}/Captures/site_captures_dirt")
except:
    num=1
        ...
        try:
            ...
            if(inp==1):
                ...
                if result:
                    ...
                    cv2.imwrite(f"/home/anshulraje/Desktop/Captures/site_captures_dirt/{site_counter}_{counter}_{timenow}.jpg", image_lined)
                    # image=0
